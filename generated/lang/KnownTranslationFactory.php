...
final class KnownTranslationFactory{
	...
	public static function pocketmine_permission_command_whatsnew() : Translatable{
		return new Translatable(KnownTranslationKeys::POCKETMINE_PERMISSION_COMMAND_WHATSNEW, []);
	}
